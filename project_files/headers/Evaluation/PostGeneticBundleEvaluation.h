#ifndef POSTGENETICBUNDLEEVALUATION_H
#define POSTGENETICBUNDLEEVALUATION_H

#include "utils.h"

class PostGeneticBundleEvaluation
{
public:
    PostGeneticBundleEvaluation();
    PostGeneticBundleEvaluation(const int &_database, int _eval_im_number=5, int setComputer=1);
    ~PostGeneticBundleEvaluation();
    void evaluate();
...
#endif // POSTGENETICBUNDLEEVALUATION_H
